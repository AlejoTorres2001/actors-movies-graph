...
let MoviesRepository = class MoviesRepository extends base_abstract_repository_1.BaseAbstractRepository {
...
MoviesRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(movies_entity_1.Movie)),
